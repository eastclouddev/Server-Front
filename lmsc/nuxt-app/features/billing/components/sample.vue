...
export default {
  ...
  data() {
    return {
      ...
      data: [
        { id: 1, billingDate: '2024/01', paymentDate: '2024/02/01', payment: 1000, status: '未請求' },
        { id: 2, billingDate: '2024/01', paymentDate: '2024/02/02', payment: 2000, status: '請求済' },
        { id: 3, billingDate: '2023/12', paymentDate: '2024/01/01', payment: 1500, status: '支払済' },
        { id: 4, billingDate: '2023/11', paymentDate: '2023/12/01', payment: 3000, status: '未請求' },
        { id: 5, billingDate: '2023/11', paymentDate: '2023/12/01', payment: 3000, status: '未請求' }
      ],
      items: [
        {
          title: 'ダッシュボード',
