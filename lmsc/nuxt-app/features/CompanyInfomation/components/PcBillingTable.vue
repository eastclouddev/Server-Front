<template>
  <v-table density="compact" class="mb-5 table_wrap" width="100%">
    ...
    <tbody>
      <tr v-for="(item, index) in filteredList.slice(0, 2)" :key="item.id" :style="{ backgroundColor: index % 2 === 0 ? '#FFFFFF' : '#EAF4F9', height: '50px' }">
        ...
        <td style="border-left: 2px solid #F5F5F5; border-right: 2px solid #F5F5F5; width:140px; height:50px;" class="d-flex align-center justify-center pl-3 pr-3">
