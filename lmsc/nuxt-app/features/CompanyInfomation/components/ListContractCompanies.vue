<template>
  <v-container style="margin-bottom:10%;padding-top: 15px !important; padding: 6%; background-color: #F5F5F5 !important">
        ...
        <template v-if="filteredList.length > 0">
          <PcCompanyTable :filteredList="filteredList" />
          <SpCompanyTable :filteredList="filteredList" />
...
import PcCompanyTable from '~/features/CompanyInfomation/components/PcCompanyTable.vue';
import SpCompanyTable from '~/features/CompanyInfomation/components/SpCompanyTable.vue';
