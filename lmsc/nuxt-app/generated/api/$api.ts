...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH15 = '/notifications/';
  const PATH16 = '/students/questions/';
  const PATH17 = '/students/reviews/';
  const PATH18 = '/mentors/counts/';
  const PATH19 = '/news/';
  const PATH20 = '/news/categories/';
  ...
  const PATH27 = '/responses/';
  const PATH28 = '/reviews/responses/';
  const PATH29 = '/rewards/';
  const PATH30 = '/samplechat/';
  const PATH31 = '/students/';
  const PATH32 = '/assign_mentor/';
  const GET = 'GET';
  const POST = 'POST';
  const PATCH = 'PATCH';
  ...
  return {
    ...
    mentors: {
      _mentor_id: (val1: number) => {
        ...
        return {
          notifications: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1hb0s9x['get']['resBody'], BasicHeaders, Methods_1hb0s9x['get']['status']>(prefix, `${prefix1}${PATH15}`, GET, option).json(),
            /**
             * 通知一覧（メンター）
             *
             * Parameters
             ...
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_1hb0s9x['get']['resBody'], BasicHeaders, Methods_1hb0s9x['get']['status']>(prefix, `${prefix1}${PATH15}`, GET, option).json().then(r => r.body),
      ...
      counts: {
         ...
         */
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1osy0o9['get']['resBody'], BasicHeaders, Methods_1osy0o9['get']['status']>(prefix, PATH18, GET, option).json(),
        /**
         * メンター担当受講生数取得
         *
         * Parameter
         ...
         */
        $get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1osy0o9['get']['resBody'], BasicHeaders, Methods_1osy0o9['get']['status']>(prefix, PATH18, GET, option).json().then(r => r.body),
        $path: () => `${prefix}${PATH18}`,
      },
    },
    news: {
      ...
      categories: {
         ...
         */
        get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1uxbl4e['get']['resBody'], BasicHeaders, Methods_1uxbl4e['get']['status']>(prefix, PATH20, GET, option).json(),
        /**
         * ニュースカテゴリ一覧取得
         *
         * Parameters
         ...
         */
        $get: (option?: { config?: T | undefined } | undefined) =>
          fetch<Methods_1uxbl4e['get']['resBody'], BasicHeaders, Methods_1uxbl4e['get']['status']>(prefix, PATH20, GET, option).json().then(r => r.body),
        $path: () => `${prefix}${PATH20}`,
      },
      /**
       * ニュース一覧取得
      ...
      get: (option: { query: Methods_t9xdat['get']['query'], config?: T | undefined }) =>
        fetch<Methods_t9xdat['get']['resBody'], BasicHeaders, Methods_t9xdat['get']['status']>(prefix, PATH19, GET, option).json(),
      /**
       * ニュース一覧取得
       *
       * Parameters
       ...
       */
      $get: (option: { query: Methods_t9xdat['get']['query'], config?: T | undefined }) =>
        fetch<Methods_t9xdat['get']['resBody'], BasicHeaders, Methods_t9xdat['get']['status']>(prefix, PATH19, GET, option).json().then(r => r.body),
      /**
       * ニュース作成
       * Parameters
       * -----------------------
      ...
      post: (option: { body: Methods_t9xdat['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_t9xdat['post']['resBody'], BasicHeaders, Methods_t9xdat['post']['status']>(prefix, PATH19, POST, option).json(),
      /**
       * ニュース作成
       * Parameters
       * -----------------------
       ...
       */
      $post: (option: { body: Methods_t9xdat['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_t9xdat['post']['resBody'], BasicHeaders, Methods_t9xdat['post']['status']>(prefix, PATH19, POST, option).json().then(r => r.body),
    ...
    notifications: {
       ...
       */
      get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_sr2fny['get']['resBody'], BasicHeaders, Methods_sr2fny['get']['status']>(prefix, PATH15, GET, option).json(),
      /**
       * 通知一覧(管理者)
       *
       * Parameters
       ...
       */
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<Methods_sr2fny['get']['resBody'], BasicHeaders, Methods_sr2fny['get']['status']>(prefix, PATH15, GET, option).json().then(r => r.body),
      $path: () => `${prefix}${PATH15}`,
    },
    password_reset: {
      confirm: {
        ...
        return {
          responses: {
            ...
            post: (option: { body: Methods_2cu3ed['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_2cu3ed['post']['resBody'], BasicHeaders, Methods_2cu3ed['post']['status']>(prefix, `${prefix1}${PATH27}`, POST, option).json(),
            /**
             * レビュー回答作成
             *
             * Parameters
             ...
             */
            $post: (option: { body: Methods_2cu3ed['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods_2cu3ed['post']['resBody'], BasicHeaders, Methods_2cu3ed['post']['status']>(prefix, `${prefix1}${PATH27}`, POST, option).json().then(r => r.body),
    ...
    rewards: {
      get: (option?: { config?: T | undefined } | undefined) =>
        fetch<void, BasicHeaders, Methods_wq2jhe['get']['status']>(prefix, PATH29, GET, option).send(),
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<void, BasicHeaders, Methods_wq2jhe['get']['status']>(prefix, PATH29, GET, option).send().then(r => r.body),
      $path: () => `${prefix}${PATH29}`,
    },
    samplechat: {
      get: (option?: { config?: T | undefined } | undefined) =>
        fetch<void, BasicHeaders, Methods_1o5yr5y['get']['status']>(prefix, PATH30, GET, option).send(),
      $get: (option?: { config?: T | undefined } | undefined) =>
        fetch<void, BasicHeaders, Methods_1o5yr5y['get']['status']>(prefix, PATH30, GET, option).send().then(r => r.body),
      $path: () => `${prefix}${PATH30}`,
    },
    students: {
      ...
      _student_id_number: (val1: number) => {
        ...
        return {
          assign_mentor: {
             ...
             */
            post: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_9ucswa['post']['status']>(prefix, `${prefix1}${PATH32}`, POST, option).send(),
            /**
             * 受講生と担当メンターの関連付け
             *
             * Parameters
             ...
             */
            $post: (option?: { config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods_9ucswa['post']['status']>(prefix, `${prefix1}${PATH32}`, POST, option).send().then(r => r.body),
          ...
          notifications: {
             ...
             */
            get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_97y4kl['get']['resBody'], BasicHeaders, Methods_97y4kl['get']['status']>(prefix, `${prefix1}${PATH15}`, GET, option).json(),
            /**
             * 通知一覧(受講生)
             *
             * Parameters
             ...
             */
            $get: (option?: { config?: T | undefined } | undefined) =>
              fetch<Methods_97y4kl['get']['resBody'], BasicHeaders, Methods_97y4kl['get']['status']>(prefix, `${prefix1}${PATH15}`, GET, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix1}${PATH15}`,
          },
          questions: {
            /**
